...
const Features = () => {
  return (
    <div className='flex flex-col items-center px-6 md:px-16 lg:px-16 bg-slate-5 py-20 bg-gray-100'>
     ...
     <div className='flex flex-wrap items-center justify-center gap-6 mt-20 '>
      ...
      <div key={index} className=" relative max-w-100 w-full rounded-xl overflow-hidden bg-white text-gray-500/90 shadow-[0px_4px_rgba(0,0,0,0.05)]">
        <img src={card.Image} alt="card_image"  className='h-90'/>
